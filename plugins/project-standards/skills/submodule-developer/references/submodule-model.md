...
- `Submodule code`
  ...
  - Rule composition: it follows the shared `Code` layer, conditionally applicable capability skills bound through `External Standard Reference Rules`, and the applicable `Submodule AGENTS.md` chain within its declared boundary.
