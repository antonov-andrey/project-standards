...
description: Classify instruction ownership or audit provider bindings, applicability, overlays, task artifacts, and owner boundaries.
---
...
A classification or proposed ownership move also applies `project-standards:project-instruction-developer`; this audit evaluates the resulting owner model but does not redefine its ledger prerequisite.
